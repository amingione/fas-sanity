...
| **SHIP_FROM_NAME** | No | Both | No | Shipping | ship-from.ts | Ship-from name/company | `'FAS Motorsports'` | Uses default | No (business config) |
...
| SHIP_FROM_NAME | `'FAS Motorsports'` | Shipper name |
