...
const sanity = createClient({
  projectId: process.env.SANITY_STUDIO_PROJECT_ID || process.env.VITE_SANITY_STUDIO_PROJECT_ID || 'r4og35qd',
  dataset: process.env.SANITY_STUDIO_DATASET || process.env.VITE_SANITY_STUDIO_DATASET || 'production',
