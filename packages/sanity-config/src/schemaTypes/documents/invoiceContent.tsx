...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      to: [{type: 'vendor'}],
      fieldset: 'customerBilling',
      description: 'Set when this invoice is tied to a vendor account.',
    }),
    ...
    defineField({
      ...
      to: [{type: 'vendorOrder'}],
      fieldset: 'relatedDocs',
      description: 'Vendor order created from this invoice.',
      hidden: ({document}) => !document?.vendorOrderRef,
    }),
    defineField({
      name: 'quote',
      title: 'Related Quote',
