...
export default defineType({
  ...
  fields: [
      ...
      of: [
        {
          ...
          fields: [
            ...
            {name: 'total', title: 'Line Total (cents)', type: 'number'},
          ],
        },
      ],
    }),
    ...
    defineField({
      ...
      hidden: true,
      fields: [
        {name: 'amountCents', title: 'Amount (cents)', type: 'number'},
        {name: 'carrier', title: 'Carrier', type: 'string'},
        {name: 'serviceName', title: 'Service Name', type: 'string'},
        {name: 'shippoRateId', title: 'Shippo Rate ID', type: 'string'},
      ],
    }),
    defineField({
      name: 'trackingNumber',
      ...
      of: [
        {
          type: 'object',
          fields: [
            {name: 'rateId', type: 'string', title: 'Rate ID'},
            ...
            {name: 'durationTerms', type: 'string', title: 'Duration Terms'},
          ],
        },
      ],
    }),
    defineField({
      name: 'shippoRatesFetchedAt',
      title: 'Shippo Rates Fetched At',
      type: 'datetime',
      group: 'fulfillment',
      readOnly: true,
      hidden: true,
    ...
    defineField({
      name: 'shippoRatesFetchedBy',
      title: 'Shippo Rates Fetched By',
      type: 'string',
      group: 'fulfillment',
      readOnly: true,
      hidden: true,
    ...
    defineField({
      name: 'shippoRateAmount',
      title: 'Shippo Rate Amount',
      type: 'number',
      group: 'fulfillment',
      readOnly: true,
      hidden: true,
    ...
    defineField({
      name: 'shippoRateCurrency',
      title: 'Shippo Rate Currency',
      type: 'string',
      group: 'fulfillment',
      readOnly: true,
      hidden: true,
    ...
    defineField({
      name: 'shippoServicelevel',
      title: 'Shippo Service Level',
      type: 'string',
      group: 'fulfillment',
      readOnly: true,
      hidden: true,
    ...
    defineField({
      name: 'shippoRateEstimatedDays',
      title: 'Shippo Rate Estimated Days',
      type: 'number',
      group: 'fulfillment',
      readOnly: true,
      hidden: true,
    ...
    defineField({
      name: 'shippoRateSelectedAt',
      title: 'Shippo Rate Selected At',
      type: 'datetime',
      group: 'fulfillment',
      readOnly: true,
      hidden: true,
    ...
    defineField({
      name: 'shippoRateSelectedBy',
      title: 'Shippo Rate Selected By',
      type: 'string',
      group: 'fulfillment',
      readOnly: true,
      hidden: true,
    ...
    defineField({name: 'packingSlipPrinted', type: 'boolean', hidden: true}),
