...
export const stripeOrderSummaryType = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'lastEventCreated', type: 'datetime', title: 'Last Event at', readOnly: true }),
    ...
    defineField({ name: 'paymentIntentId', type: 'string', title: 'Payment Intent ID', readOnly: true }),
    defineField({ name: 'paymentIntentCreated', type: 'datetime', title: 'Payment Intent Created', readOnly: true }),
    defineField({ name: 'checkoutSessionId', type: 'string', title: 'Checkout Session ID', readOnly: true }),
    defineField({ name: 'checkoutStatus', type: 'string', title: 'Checkout Status', readOnly: true }),
    defineField({ name: 'checkoutExpiresAt', type: 'datetime', title: 'Checkout Expires At', readOnly: true }),
